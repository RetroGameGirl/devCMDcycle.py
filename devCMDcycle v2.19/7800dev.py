...
"""
7800 Dev Commander v2.19

This application is a configurable front-end for managing software build
environments, particularly for retro game development. It is based on the
original 7800dev.py program by RetroGameGirl.
...
# --- Global Constants ---
CONFIG_FILE_NAME = '7800_dev_commander_v2_19.ini'
...
# the blueprint for the `7800_dev_commander_v2_18.ini` file that is
...
#
    def __init__(self, root):
        self.root = root
        self.root.title("7800 Dev Commander v2.19")
        self.config = {}
        self.process = None
...
#
    def open_about_window(self):
        ...
        about_win.title("7800 Dev Commander v2.19 - User Manual")
