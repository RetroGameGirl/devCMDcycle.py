...
# --- Global Constants ---
CONFIG_FILE_NAME = 'devCMDcycle_237.ini'
APP_VERSION = "2.37"
...
#   %NOP: No operation. Use this for buttons that only trigger an auto-typer.
...
#
# ---
# Dynamic Auto-Typer Special Placeholders:
#   %C<key>: Sends a control character (e.g., %C<c> sends CTRL+C).
#   %A<key>: Sends an alt character (e.g., %A<f> sends ALT+F).
#   %b<num>: Creates a text entry box of <num> width in the Settings UI.
#
# ---
# Composite Commands:
...
DEFAULT_CONFIG = {
    ...
    'Options': {
        ...
        'active_auto_typer_profile': 'Default 7800 Header',
    ...
    'ToolchainStates': {},
    'AutoTyperProfiles': {
        'Default 7800 Header': str({
            'Step 1': {'name': 'Cartridge & Memory', 'column': 1, 'commands': [
                {'label': 'Button8', 'command': 'set linear', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set supergame', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set souper', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set bankset', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set absolute', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set activision', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set rom@4000', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set bank6@4000', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set ram@4000', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set mram@4000', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set hram@4000', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set bankram', 'enabled': 'False', 'text': ''}
            ]},
            'Step 2': {'name': 'Hardware & IRQs', 'column': 1, 'commands': [
                {'label': 'Button8', 'command': 'set pokey@440', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set pokey@450', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set pokey@800', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set pokey@4000', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set ym2151@460', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set covox@430', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set adpcm@420', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set irqpokey1', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set irqpokey2', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set irqym2151', 'enabled': 'False', 'text': ''}
            ]},
            'Step 3': {'name': 'Controllers', 'column': 2, 'commands': [
                {'label': 'Button8', 'command': 'set 7800joy1', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set 7800joy2', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set lightgun1', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set lightgun2', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set paddle1', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set paddle2', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set 2600joy1', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set 2600joy2', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set keypad1', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set keypad2', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set mega78001', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set mega78002', 'enabled': 'False', 'text': ''}
            ]},
            'Step 4': {'name': 'Misc & TV', 'column': 2, 'commands': [
                {'label': 'Button8', 'command': 'set hsc', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set savekey', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set xm', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set tvpal', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set tvntsc', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'set composite', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'set mregion', 'enabled': 'False', 'text': ''}
            ]},
            'Step 5': {'name': 'Final Actions', 'column': 3, 'commands': [
                {'label': 'Button8', 'command': 'name "%b25"', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'save', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'strip', 'enabled': 'False', 'text': ''},
                {'label': 'Button8', 'command': 'fix', 'enabled': 'False', 'text': ''}, {'label': 'Button8', 'command': 'exit', 'enabled': 'False', 'text': ''}
            ]}
        })
    },
    'Toolchains': {
        ...
        '7800ASMDevKit': {
            ...
            'custom_buttons': str({
                ...
                'Button10': {'name': 'Test', 'command': '%NOP', 'color': '#F0F0F0'}
            })
        },
        'cc65': {
            'path': 'cl65',
...
#
# Initializes the AutoTyperProfileEditor window.
#
...
#
# Creates the top bar for profile management (select, add, rename, delete).
#
...
#
# Creates the main editor area with tabs and placeholder legend.
#
    def create_editor_area(self, parent):
        ...
        ttk.Button(button_frame, text="Save & Close", command=self.save_and_close, style="Accent.TButton").pack(side='right')

        # --- Right Side: Legend ---
        self.create_legend(container)
#
# Creates the content for a single tab in the editor notebook.
#
...
#
# Creates the placeholder legend on the right side of the editor.
#
...
#
# Adds a new, blank command row to a specified tab.
#
...
#
# Populates the profile selection combobox.
#
    def populate_profile_list(self):
        profiles = sorted(list(self.app.config.get('AutoTyperProfiles', {}).keys()))
...
#
# Loads the data for the selected profile into the editor UI.
#
...
#
# Saves the current state of the editor UI back to the config.
#
    def save_profile_data(self, *args):
        profile_name = self.profile_var.get()
        if not profile_name: return

        # --- Persist the existing state of checkboxes and text fields ---
        try:
        ...
        for tab_key, rows in self.command_rows.items():
            # Find the old command list to preserve states
            ...
            for i, r in enumerate(rows):
                ...
                # If a command at the same index exists, preserve its state
...
#
    def add_new_profile(self):
        ...
        blank_profile = {f'Step {i}': {'name': f'Step {i}', 'column': 1, 'commands': []} for i in range(1, 6)}
...
#
    def rename_profile(self):
        ...
        self.app.config['AutoTyperProfiles'][new_name] = self.app.config['AutoTyperProfiles'].pop(old_name)
        self.populate_profile_list()
        self.profile_var.set(new_name)
#
...
#
    def delete_profile(self):
        ...
        if messagebox.askyesno("Confirm Delete", f"Are you sure you want to delete profile '{profile_name}'?", parent=self):
            ...
            self.load_profile_data()
#
# Deletes a command row from a tab.
#
    def delete_row(self, row_frame, tab_key):
        ...
        if row_to_delete:
            ...
            self.save_profile_data()
#
# Moves a command row up or down in its list.
#
    def move_row(self, row_frame, tab_key, direction):
        ...
        self.save_profile_data()
#
# Saves geometry and calls the refresh callback before closing.
#
...
#
    def __init__(self, parent, app_controller):
        ...
        self.vars = {}
        self.clean_vars = {}
        self.autotyper_state_vars = {} # Holds tuples of (tk.Var, profile_name, step_key, index)
...
# This was completely rewritten to support the new dynamic, profile-based system.
#
    def create_header_settings(self, parent):
        ...
        self.vars['header_auto_send_command'].trace_add('write', lambda *a, k='header_auto_send_command': self._on_option_var_change(k, *a))
        cb = ttk.Checkbutton(controls_frame, text="Enable Auto-Typer (Master Switch)", variable=self.vars['header_auto_send_command'])
        cb.grid(row=2, column=0, columnspan=2, sticky='w', pady=(10,0))
        return frame
#
# Rebuilds the dynamic UI for the auto-typer based on the selected profile.
#
    def rebuild_dynamic_autotyper_ui(self, *args):
        self.save_autotyper_states() # Save current states before rebuilding
        ...
        try:
            profile_data_str = self.app.config.get('AutoTyperProfiles', {}).get(profile_name, '{}')
        ...
        columns = []
        for i in range(3):
            col = ttk.Frame(self.dynamic_autotyper_frame)
        ...
        for step_key, step_data in sorted(profile_data.items()):
            col_num = step_data.get('column', 1)
            steps_by_column[col_num].append((step_key, step_data))

        # --- Get button names from current toolchain ---
        toolchain_name = self.app.toolchain_type.get()
        toolchain_data = self.app.config.get('Toolchains', {}).get(toolchain_name, {})
        try:
            buttons_data = ast.literal_eval(toolchain_data.get('custom_buttons', '{}'))
        ...
        for col_num, steps in sorted(steps_by_column.items()):
            parent_col = columns[col_num - 1] # -1 for 0-based index
            for step_key, step in steps:
                step_name = step.get('name', step_key)
                commands = step.get('commands', [])
                if not commands: continue

                step_frame = ttk.LabelFrame(parent_col, text=step_name, padding=5)
                step_frame.pack(fill='x', expand=True, pady=(0, 10))
                
                for j, command_item in enumerate(commands):
                    label_key = command_item.get('label', 'Button1')
                    command_str = command_item.get('command', '')
                    
                    label_button_name = buttons_data.get(label_key, {}).get('name', label_key)
                    if not label_button_name.strip(): # Fallback if name is empty
                        label_button_name = label_key

                    row_frame = ttk.Frame(step_frame)
                    ...
                    # --- Entry box or preview label ---
                    match = re.search(r'%b(\d+)', command_str)
                    if match:
                        width = int(match.group(1))
                        text_var = tk.StringVar(value=command_item.get('text', ''))
                        
                        label_and_entry_frame = ttk.Frame(row_frame)
                        label_and_entry_frame.pack(side='left', fill='x', expand=True, padx=(5,0))
                        ttk.Label(label_and_entry_frame, text=f"{label_button_name}:").pack(side='left', padx=(0, 5))
                        
                        entry = ttk.Entry(label_and_entry_frame, textvariable=text_var, width=width)
                        entry.pack(side='left', fill='x', expand=True)
                        
                        # --- Create unique key for vars and add trace for immediate saving ---
                        key = (profile_name, step_key, j)
                        ...
                        # --- Create unique key for var and add trace for immediate saving ---
                        key = (profile_name, step_key, j)
...
#
# Callback to immediately save the state of a single clean file extension checkbox.
#
...
#
    def load_settings_into_ui(self):
        ...
        # --- Populate Auto-Typer Profile Selector ---
        profiles = sorted(list(self.app.config.get('AutoTyperProfiles', {}).keys()))
        self.profile_combo['values'] = profiles
        ...
        if active_profile in profiles:
            ...
            self.vars['active_auto_typer_profile'].set(profiles[0])
...
#
    def open_toolchain_editor(self):
        self._save_all_settings_vars()
        ToolchainEditorWindow(self, self.app)
#
# Opens the new auto-typer profile editor window.
#
    def open_auto_typer_editor(self):
        self._save_all_settings_vars()
        AutoTyperProfileEditor(self, self.app, self.load_settings_into_ui)
#
# Saves the state of the dynamic auto-typer controls back to the config profile.
#
    def save_autotyper_states(self):
        for key, (check_var, text_var) in self.autotyper_state_vars.items():
            ...
            try:
                ...
                # This can happen if the profile was edited externally, just skip
                continue
#
# Callback to immediately save the state of a single auto-typer control.
#
    def _on_autotyper_state_change(self, key):
        if not self.winfo_exists(): return # Window might be closing

        check_var, text_var = self.autotyper_state_vars[key]
        profile_name, step_key, index = key
        ...
        try:
            ...
            self.app.config['AutoTyperProfiles'][profile_name] = str(profile_data)
            self.app.save_config() # Save immediately to INI
        except (ValueError, SyntaxError, KeyError, IndexError):
            pass # Fail silently if data structure is somehow out of sync
#
# Immediately saves an option from the self.vars dict to the config.
#
    def _on_option_var_change(self, key, *args):
        ...
        if key in self.vars:
            ...
            self.app.save_config()
#
# A helper to save all UI variables to the config object before an action.
#
    def _save_all_settings_vars(self):
...
#
    def create_option_row(self, option_data=None):
        ...
        target_var = tk.StringVar(value=option_data.get('target', '')) # Stores 'ButtonX'
        target_display_var = tk.StringVar() # Stores the user-friendly name
        ...
        # Store the actual data var, not the display var
    ...
    def load_config(self):
        ...
        for section in parser.sections():
            if section.startswith('Toolchain:'):
                ...
                self.config['Toolchains'][name].update(dict(parser.items(section)))
            else:
...
#
    def save_config(self):
        ...
        standard_sections = [s for s in config_to_save.keys() if s != 'Toolchains']
        for section in standard_sections:
            if isinstance(config_to_save[section], dict):
                parser[section] = {k: str(v) for k, v in config_to_save[section].items()}

        # --- Handle toolchains section ---
...
#
    def create_status_widgets(self, parent):
        ...
        try:
            ...
            self.output_text.tag_configure("prompt", foreground="#ffc107", font=italic_font) # Yellow for prompts
        except tk.TclError: pass
...
#
    def on_toolchain_selected(self, *args):
        ...
        for option in toolchain_options:
            ...
            var.set(saved_state)
            cb = ttk.Checkbutton(self.toolchain_options_cb_frame, text=name, variable=var)
            cb.pack(anchor='w')
        ...
        for target in sorted(list(preview_targets)):
            ...
            # Bind the configure event to the label itself to dynamically set its wraplength
            preview_label.bind('<Configure>', lambda e: e.widget.config(wraplength=e.widget.winfo_width()))
            self.preview_labels[target] = preview_label
            self._update_toolchain_state_and_preview(target)
        
        self.rebuild_action_buttons()
#
# Updates the text wrapping for the preview labels when the window is resized.
#
    def _update_preview_wraps(self, event=None):
        if not hasattr(self, 'preview_labels') or not hasattr(self, 'toolchain_options_cb_frame'):
            return
        width = self.toolchain_options_cb_frame.winfo_width()
        if width > 20:
            for label in self.preview_labels.values():
                # We subtract a bit for padding and the "Preview:" label text
...
#
    def open_about_window(self):
        ...
        manual_content = [
            ...
            ("Edit Toolchains... & Manage Auto-Typer Profiles...:\n", "bold"),
            ("These buttons open dedicated editor windows for creating and managing your build environments and automated command scripts.\n\n", ""),
            ...
            ("Auto-Typer Settings:\n", "bold"),
            ("This has been completely overhauled. You can now select a profile from a dropdown. The UI below it will dynamically update to show all commands from that profile, complete with checkboxes to enable/disable them and text boxes for commands that require user input (defined with %b<num> in the profile editor).\n\n", ""),
            ("The Auto-Typer Profile Editor\n", "h2"),
            ("This new window is the heart of the dynamic auto-typer system.\n\n", ""),
            ("Profile Management:\n", "bold"),
            ("At the top, you can select, add, rename, and delete profiles.\n\n", ""),
            ("Tabbed Steps:\n", "bold"),
            ("Create up to 5 sequential steps for your script using the tabs. You can name each tab and assign it to one of three display columns in the Settings window. The script will execute the commands in Tab 1, then Tab 2, and so on.\n\n", ""),
            ("Command Editor:\n", "bold"),
            ("Within each tab, you can add, delete, and re-order individual command lines. Each command has a 'Label' (what you see in the Settings window) and a 'Command' (what gets typed, including special placeholders).\n\n", ""),
            ("Special Placeholders:\n", "bold"),
            (" • %C<key>: Sends CTRL + key (e.g., %C<c> for CTRL+C).\n", ""),
            (" • %A<key>: Sends ALT + key (e.g., %A<f> for ALT+F).\n", ""),
            (" • %b<num>: Creates a text input box in the Settings window of 'num' character width.\n\n", ""),
            ("License Information\n", "h2"),
...
#
    def log_and_run(self, button_name, action, *args, **kwargs):
        ...
        action(*args, **kwargs)
#
# Central command handler. Determines command type and passes to the correct executor.
#
    def run_command(self, on_success, command_override, target_button, autotyper_trigger_key=None):
        if self.command_running:
            # This check prevents two internal commands from running over each other.
            # An auto-typer dummy process is an internal command, so this is important.
        ...
        final_command_str = self.resolve_command_placeholders(
            action_key=None,
            command_override=command_override,
            target_button=target_button
        )

        is_external = final_command_str.strip().startswith('EXTERNAL:')
        is_nop = final_command_str.strip() == '%NOP'

        # Case 1: External command
        if is_external:
            cmd_to_run = final_command_str.strip()[len('EXTERNAL:'):].strip()
            self.run_external_command(cmd_to_run, on_success) # Fire-and-forget
            # If it also triggers an auto-typer, launch the dummy process in parallel.
            if autotyper_trigger_key:
                self.execute_internal_command("", on_success=None, autotyper_trigger_key=autotyper_trigger_key, close_after_typing=True)
            return

        # Case 2: NOP or blank command (exists only to trigger auto-typer)
        if is_nop or not final_command_str.strip():
            if autotyper_trigger_key:
                self.execute_internal_command("", on_success, autotyper_trigger_key=autotyper_trigger_key, close_after_typing=True)
            elif on_success:
                self.root.after(10, on_success) # Still need to continue chain
            return

        # Case 3: Standard internal command
...
#
    def run_external_command(self, command_to_run, on_success=None):
        ...
        try:
            ...
            cmd_arg = command_to_run if use_shell else shlex.split(command_to_run)

            subprocess.Popen(cmd_arg, cwd=os.path.dirname(self.source_file.get()) or None, shell=use_shell, creationflags=flags)
            # External commands are non-blocking, so call the success callback immediately to allow composite chains to continue.
            if on_success:
                 self.root.after(10, on_success)
        except Exception as e:
            self.log_output(f"Error launching external process: {e}", tag='error')
            # Also call on_success here to not break a chain on error
            if on_success:
                self.root.after(10, on_success)
#
...
#
    def execute_internal_command(self, command_string, on_success, autotyper_trigger_key=None, close_after_typing=False):
        if self.command_running:
            self.log_output("Error: An internal command is already running.", tag='error')
            # If there's a callback, we should call it to prevent the chain from stopping.
            if on_success:
                self.root.after(10, on_success)
            return

        working_dir = os.path.dirname(self.source_file.get()) if self.source_file.get() else None
        is_dummy_process = not command_string.strip()

        try:
            self.set_command_running_state(True)
            if sys.platform != "win32":
                try: 
                    cmd_list = ['/bin/sh', '-i'] if is_dummy_process else shlex.split(command_string)
                ...
                cmd_to_run = 'cmd.exe' if is_dummy_process else command_string
                self.process = subprocess.Popen(cmd_to_run, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, stdin=subprocess.PIPE, cwd=working_dir, text=True, bufsize=1, creationflags=subprocess.CREATE_NO_WINDOW, shell=True)
...
#
# Runs an automated sequence of commands based on the selected dynamic auto-typer profile.
#
    def _run_automated_header_sequence(self, trigger_key, close_after=False):
        try:
            initial_delay = float(self.config['Options'].get('header_initial_delay', 1.0))
            command_delay = float(self.config['Options'].get('header_command_delay', 0.5))
            
            profile_name = self.config.get('Options', {}).get('active_auto_typer_profile')
            if not profile_name: return

            profile_data_str = self.config.get('AutoTyperProfiles', {}).get(profile_name, '{}')
            profile_data = ast.literal_eval(profile_data_str)
        except (ValueError, SyntaxError):
            self.log_output("Error: Could not parse auto-typer profile or settings.", tag='error')
            return
            
        time.sleep(initial_delay)
        
        for step_key in sorted(profile_data.keys()):
            step = profile_data[step_key]
            commands = step.get('commands', [])
            
            for command_item in commands:
                if not self.command_running: break
                
                if command_item.get('label') != trigger_key: continue
                if command_item.get('enabled', 'False').lower() != 'true': continue

                command_str = command_item.get('command', '')

                def replace_b_placeholder(match):
                    return command_item.get('text', '')
                
                resolved_cmd = re.sub(r'%b\d+', replace_b_placeholder, command_str)
                self._send_auto_typer_command(resolved_cmd)
        ...
        if close_after and self.process and self.process.poll() is None:
            ...
            if sys.platform == "win32":
                self.process.terminate() # On Windows, exit may not be enough
#
# Sends a single command string for the auto-typer, parsing for special key placeholders.
#
    def _send_auto_typer_command(self, command):
        parts = re.split(r'(%[CA]<.>)', command)
        for part in filter(None, parts):
            if not self.command_running: break
            match = re.match(r'%([CA])<(.)>', part)
            if match:
                modifier, key = match.groups()
                # Log a user-friendly version of the command
                self.log_output(f"Sending {modifier.replace('C', 'CTRL').replace('A', 'ALT')}+{key}", tag='prompt')
                key_char = key.lower()
                if modifier == 'C':
                    char_code = ord(key_char) - ord('a') + 1 if 'a' <= key_char <= 'z' else ord(key_char)
                    self._send_bytes_to_process(bytes([char_code]))
                elif modifier == 'A':
                    self._send_bytes_to_process(b'\x1b' + key_char.encode())
            else:
                self.log_output(f"$ {part}", tag='user_input')
                for char in part:
                    self._send_bytes_to_process(char.encode())
                    time.sleep(0.03)
        self._send_bytes_to_process(b'\n')
#
# Helper method to write raw bytes to the running process's stdin.
#
    def _send_bytes_to_process(self, data_bytes):
        if self.command_running and self.process and self.process.poll() is None:
            try:
                if sys.platform != "win32" and self.master_fd:
                    os.write(self.master_fd, data_bytes)
                else:
                    self.process.stdin.write(data_bytes.decode('utf-8', errors='replace'))
                    self.process.stdin.flush()
            except (IOError, OSError, BrokenPipeError):
                self.log_output("Info: Process closed.", tag='info')
#
...
#
    def send_break_signal(self):
        if self.process and self.process.poll() is None:
            ...
            self.log_output("\n--- Sent break signal ---\n", tag='error')
#
# Central dispatcher for all button clicks, handling commands and auto-typer logic.
#
    def execute_custom_button(self, button_key):
        ...
        # --- Helper function to check if ANY button key is an autotyper trigger ---
        def is_autotyper_trigger(key_to_check):
            auto_typer_enabled = self.config['Options'].get('header_auto_send_command', 'False').lower() == 'true'
            if not auto_typer_enabled:
                return False
            ...
            try:
                profile_str = self.config.get('AutoTyperProfiles', {}).get(profile_name, '{}')
                profile_data = ast.literal_eval(profile_str)
                for step in profile_data.values():
                    for cmd_item in step.get('commands', []):
                        if cmd_item.get('label') == key_to_check and cmd_item.get('enabled', 'False').lower() == 'true':
                            return True
            except (ValueError, SyntaxError):
                pass
            return False

        if not command and not is_autotyper_trigger(button_key):
            return
        ...
        action_queue = deque()
        if is_composite:
            action_queue.extend([b.strip() for b in command.split(',') if b.strip()])
        elif command:
            action_queue.append(command)
        elif is_autotyper_trigger(button_key):  # Handle %NOP or blank command case
            action_queue.append('%NOP')
        ...
        def run_next_in_chain():
            ...
            # For composite chains, the item is a button key. For single commands, it's the command itself.
            target_button = item_from_queue if is_composite else button_key
            actual_cmd = buttons_data.get(target_button, {}).get('command', item_from_queue) if is_composite else item_from_queue
            
            # Dynamically check if THIS step in the chain should trigger an auto-typer.
            autotyper_key_for_this_step = target_button if is_autotyper_trigger(target_button) else None

            self.run_command(
                on_success=run_next_in_chain if action_queue else None,
                command_override=actual_cmd,
                target_button=target_button,
                autotyper_trigger_key=autotyper_key_for_this_step
            )
